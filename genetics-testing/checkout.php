        ...
        <div class="row">
            <div class="col-lg-6">
              <div class="toggle_info">
                  <span><i class="fa fa-user"></i>Returning customer? <a href="#loginform" data-toggle="collapse" class="collapsed" aria-expanded="false">Click here to login</a></span>
                </div>
            ...
            <div class="col-lg-6">
              <div class="toggle_info">
                <span><i class="fa fa-tag"></i>Have a coupon? <a href="#coupon" data-toggle="collapse" class="collapsed" aria-expanded="false">Click here to enter your code</a></span>
                </div>
                ...
                <div class="order_review">
                    ...
                    <div class="table-responsive order_table">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>Package 1 <span class="product-qty">x 2</span></td>
                                    <td>Rs.90.00</td>
                                </tr>
                                <tr>
                                    <td>Package 2 <span class="product-qty">x 1</span></td>
                                    <td>Rs.55.00</td>
                                </tr>
                                <tr>
                            ...
                            <tfoot>
                                <tr>
                                    <th>SubTotal</th>
                                    <td class="product-subtotal">Rs.349.00</td>
                                </tr>
                                <tr>
                                    <th>Shipping</th>
                                    <td>Free Shipping</td>
                    ...
                    <div class="payment_method">
                        ...
                        <div class="payment_option">
                            ...
                            <div class="custome-radio">
                                ...
                                <p data-method="option4" class="payment-text">You can also pay at the time of delivery.</p>
                            </div>
                            <div class="custome-radio">
                       ...
                       <a class="ttm-btn buy-btn ttm-btn-size-sm ttm-btn-shape-round ttm-icon-btn-right ttm-btn-color-skincolor" href="order-complete.php" title="">Place Order<i class="ti ti-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
    </div>
