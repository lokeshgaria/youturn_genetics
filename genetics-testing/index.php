          ...
          <div class="col-md-4"> 
            ...
            <div class="featured-icon-box icon-align-top-content text-center style4">
              ...
              <div class="featured-content">
                ...
                <br>
                <a class="ttm-btn" href="results.php">Read More</a> </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                      <div class="text-md-right res-991-pt-30">
                        ...
                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded buy-btn  ttm-btn-color-skincolor" href="contact.php">Get a Quote Now</a> </div>
                    </div>
                  </div>
                </div>
              </div>
